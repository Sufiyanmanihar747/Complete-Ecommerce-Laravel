      ...
      <ul class="product-list">
        ...
        <li>
          <div class="product-card">
            ...
            <div class="card-content">
              <h3 class="h4 card-title">
                <a href="#" class="text-decoration-none">Grand Atlantic Chukka Boots</a>
              </h3>
        ...
        <li>
          <div class="product-card">
            ...
            <div class="card-content">
              <h3 class="h4 card-title">
                <a href="#" class="text-decoration-none">Women's Faux-Trim Shirt</a>
              </h3>
        ...
        <li>
          <div class="product-card">
            ...
            <div class="card-content">
              <h3 class="h4 card-title">
                <a href="#" class="text-decoration-none">Soft Touch Interlock Polo</a>
              </h3>
        ...
        <li>
          <div class="product-card">
            ...
            <div class="card-content">
              <h3 class="h4 card-title">
                <a href="#" class="text-decoration-none">TrendBazaar Smart Watch</a>
              </h3>
        ...
        <li>
          <div class="product-card">
            ...
            <div class="card-content">
              <h3 class="h4 card-title">
                <a href="#" class="text-decoration-none">TrendBazaar Smart Glass</a>
              </h3>
        ...
        <li>
          <div class="product-card">
            ...
            <div class="card-content">
              <h3 class="h4 card-title">
                <a href="#" class="text-decoration-none">Cotton Shirt for Men</a>
              </h3>
        ...
        <li>
          <div class="product-card">
            ...
            <div class="card-content">
              <h3 class="h4 card-title">
                <a href="#" class="text-decoration-none">Double-breasted Blazer</a>
              </h3>
        ...
        <li>
          <div class="product-card">
            ...
            <div class="card-content">
              <h3 class="h4 card-title">
                <a href="#" class="text-decoration-none">Ribbed Cotton Bodysuits</a>
              </h3>
