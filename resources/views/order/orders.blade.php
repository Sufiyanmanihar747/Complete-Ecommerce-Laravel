...
@section('content')
  ...
  @else
  <div class="my-4 display-6 text-center">
    My orders
  </div>
    @foreach ($allOrders as $order)
      @php
        $totalItems = 0;
      @endphp
      <div class="container mb-3 background-transparent rounded p-3 shadow-lg">
              ...
              <div class="col-md-2" style="align-self: center">
                <div class="carousel slide" data-interval="false">
                  <div class="carousel-inner">
                    ...
                    @endphp
                    <img src="{{ isset($imageArray[0]) ? url('storage/images/' . $imageArray[0]) : 'null' }}"
                      class="w-75" alt="{{ $imageArray[0] }}">
                  </div>
                </div>
              </div>
